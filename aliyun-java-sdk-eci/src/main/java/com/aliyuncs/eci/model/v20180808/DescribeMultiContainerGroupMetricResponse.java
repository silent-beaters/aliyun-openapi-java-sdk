...
public class DescribeMultiContainerGroupMetricResponse extends AcsResponse {
	...
	public static class Record {
		...
		public static class PodStat {
			...
			private List<FsStats> filesystem;
			...
			public List<DiskStats> getDisk() {
				return this.disk;
			}

			public void setDisk(List<DiskStats> disk) {
				this.disk = disk;
			}
			...
			public List<FsStats> getFilesystem() {
				return this.filesystem;
			}

			public void setFilesystem(List<FsStats> filesystem) {
		...
		public static class ContainerInfo {
			...
			private List<ContainerStatsItem> containerStats;
			...
			public List<ContainerStatsItem> getContainerStats() {
				return this.containerStats;
			}

			public void setContainerStats(List<ContainerStatsItem> containerStats) {
			...
			public static class ContainerStatsItem {

				private String timestamp;

				private List<FsStatsItem> fsStats;

				private List<AcceleratorStatsItem> acceleratorStats;
				...
				public List<FsStatsItem> getFsStats() {
					return this.fsStats;
				}

				public void setFsStats(List<FsStatsItem> fsStats) {
					this.fsStats = fsStats;
				}

				public List<AcceleratorStatsItem> getAcceleratorStats() {
					return this.acceleratorStats;
				}

				public void setAcceleratorStats(List<AcceleratorStatsItem> acceleratorStats) {
				...
				public static class FsStatsItem {
				...
				public static class AcceleratorStatsItem {
				...
				public static class NetworkStats {
					...
					private List<InterfaceStatsItem> interfaceStats;
					...
					public List<InterfaceStatsItem> getInterfaceStats() {
						return this.interfaceStats;
					}

					public void setInterfaceStats(List<InterfaceStatsItem> interfaceStats) {
					...
					public static class InterfaceStatsItem {
